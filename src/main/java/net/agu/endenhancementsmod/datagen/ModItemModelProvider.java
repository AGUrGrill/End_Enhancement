...
public class ModItemModelProvider extends ItemModelProvider
{
    ...
    protected void registerModels()
    {
        ...
        trimmedArmorItem(ModItems.ENDRIX_HELMET);
        trimmedArmorItem(ModItems.ENDRIX_CHESTPLATE);
        trimmedArmorItem(ModItems.ENDRIX_LEGGINGS);
        trimmedArmorItem(ModItems.ENDRIX_BOOTS);
    }
    ...
    private void trimmedArmorItem(RegistryObject<Item> itemRegistryObject) {
        final String MOD_ID = AGUEndMod.MODID; // Change this to your mod id
